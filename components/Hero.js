  ...
  return (
    <div className= 'text-white'>
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        ...
        <Link href="/dashboard"><button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black hover:bg-[#00c987] transition-all duration-300 cursor-pointer'>Get Started</button></Link> 
      </div>
    </div>
  );
};
